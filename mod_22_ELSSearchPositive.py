...
def fn_ELSSearch(sL, sN, DELSO, DLO):
    ...
    """ ## MODULE.FUNCTION() #22 - ## RETURNS: DictOfMatches """

    ## TEST PRINT OUTPUT
    print("\n")  ## PRINT SPACE
    print("WITHIN FUNCTION:  BEGIN FUNCTION #22 - ELS SEARCH - POSITIVE DIRECTION;")
    ...
    ## TEST PRINT OUTPUT
    print("\n")  ## PRINT SPACE
    print("WITHIN FUNCTION:  END FUNCTION #22 - ELS SEARCH - POSITIVE DIRECTION;")
