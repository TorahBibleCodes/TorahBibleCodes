...
import mod_3B_TextFileParse ## MODULE.FUNCTION() #3B - TEXT FILE PARSE
...
def fn_TextFilePreprocess(JSON):
    ...
    if isinstance(JSON, str):
        ...
        JSONParsed = mod_3B_TextFileParse.fn_TextFileParse(JSON)
    ...
    ## ELSE IF JSON IS A TUPLE... ## IF TEXT CHOSEN IS ALL FIVE (5) TEXTS
        ...
        for each in JSON:
            ...
            JSONParsed = mod_3B_TextFileParse.fn_TextFileParse(each)
