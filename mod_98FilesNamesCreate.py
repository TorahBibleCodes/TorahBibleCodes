...
def fn_FileNamesCreate(XW, YH, NumberOfTextChosen):
    ...
    ## CREATE DYNAMIC FILE NAME FOR CSV_FILES
    FileNameForMatrix = f"USER_FILE_Matrix2D_{NumberOfTextChosen}{TextTitle}_{XWString}x{YHString}.csv"
    FileNameForGematriaTexts = f"USER_FILE_GematriaValues_WordsOfSelectedTexts_{NumberOfTextChosen}{TextTitle}_{XWString}x{YHString}.csv"
    FileNameForGematriaELSs = f"USER_FILE_GematriaValues_WordsOfELSs_{NumberOfTextChosen}{TextTitle}_{XWString}x{YHString}.csv"
    ...
    return(FileNameForMatrix, FileNameForGematriaTexts, FileNameForGematriaELSs)
