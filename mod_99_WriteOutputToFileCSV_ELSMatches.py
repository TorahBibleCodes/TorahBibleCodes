...
## DECLARE VARIABLES
headers = ["(n, d, k)", "[Gematria of ELS]", "ELS Search Term", "Found in WordNumber In Text", "WordCoordinatesDWTK", "Found in Word In Text", \
...
def fn_WriteOutputToFile(TupleOfTuples, FileNameForELSMatches):
    ...
    with open(FileNameForELSMatches,'w', encoding="utf-8", newline='') as f:
