...
def fn_SearchForELSSearchTerms(ListOfSearchTerms, L, ListOfIndexesCustom):
    ...
    ## TEST PRINT OUTPUT
    print("\n")  ## PRINT SPACE
    print("WITHIN FUNCTION:  BEGIN FUNCTION #91 - SEARCH FOR ELS SEARCH TERMS;")
    ...
    ## BEGIN FOR LOOP
    for ELSSearchTerm in ListOfSearchTerms:
    ...
    ## TEST PRINT OUTPUT
    print("\n")  ## PRINT SPACE
    print("WITHIN FUNCTION:  END FUNCTION #91 - SEARCH FOR ELS SEARCH TERMS;")

    ## RETURN VARIABLES TO PROGRAM
    return(ListOfListOfSeries4EachLetterInText)

## END FUNCTION () # SEARCH FOR ELS SEARCH TERMS;