...
## FUNCTION () #3A - TEXT FILE PARSE
def fn_TextFileParse(DVK): ## DictOfVersesForKoren

    """
    ## MODULE.FUNCTION() #3AA - TEXT FILE PARSE ## RETURNS TextParsedWithSpaces, TextParsedNoSpaces
    """
...
## END FUNCTION () #3AA - TEXT FILE PARSE
