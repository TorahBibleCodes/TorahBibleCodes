...
## FUNCTION () #3A - TEXT FILE PREPROCESS - FIX KEYS

def fn_FixKeys(ListOfTupleKeysToFix):
    
    """
    ## MODULE.FUNCTION() #3A - TEXT FILE PREPROCESS - FIX KEYS; ## RETURNS ListOfTupleKeys - FIXED
    """

    ## TEST PRINT OUTPUT
    print("\n")  ## PRINT SPACE
    print("WITHIN FUNCTION:  BEGIN FUNCTION #3A TEXT FILE PREPROCESS - FIX KEYS")
    ...
    ## TEST PRINT OUTPUT
    print("\n")  ## PRINT SPACE
    print("WITHIN FUNCTION:  END FUNCTION #3A - TEXT FILE PREPROCESS - FIX KEYS")

    ## RETURN VARIABLES TO PROGRAM
    return(ListOfTupleKeys)
    
## END FUNCTION () #3A - END TEXT FILE PREPROCESS - FIX KEYS
