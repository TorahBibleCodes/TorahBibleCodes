...
def fn_FileNamesCreate(XW, YH, NumberOfTextChosen):
    ...
    FileNameForELSMatchesPositive = f"USER_FILE_WordsOfELSs_ELSMatchesPositiveALL_{NumberOfTextChosen}{TextTitle}_{XWString}x{YHString}.csv"
    FileNameForELSMatchesNegative = f"USER_FILE_WordsOfELSs_ELSMatchesNegativeALL_{NumberOfTextChosen}{TextTitle}_{XWString}x{YHString}.csv"
    ...
    return(FileNameForMatrixXLSX, FileNameForMatrixCSV, FileNameForGematriaTexts, FileNameForGematriaELSs,  FileNameForELSMatchesPositive,  FileNameForELSMatchesNegative)
