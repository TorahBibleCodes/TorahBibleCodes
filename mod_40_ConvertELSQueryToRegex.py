## BEGIN FUNCTION () #40 - CONVERT EACH LETTER IN ELS SEARCH QUERY TO NUMBER VALUES
...
def fn_ConvertELSQueryToRegex(ListOfSearchTerms):
    ...
    ## TEST PRINT OUTPUT
    print("\n")  ## PRINT SPACE
    print("WITHIN FUNCTION:  BEGIN FUNCTION #40 - CONVERT EACH LETTER IN ELS SEARCH QUERY TO NUMBER VALUES")
    ...
    ## TEST PRINT OUTPUT
    print("\n")  ## PRINT SPACE
    print("WITHIN FUNCTION:  END FUNCTION #40 - CONVERT EACH LETTER IN ELS SEARCH QUERY TO NUMBER VALUES")
    
    ## RETURN VARIABLES
    ## return(ListOfRegexStrings)
    return(ListOfNumberValues4ELSSearchTerms) ## RETURNS LIST OF LISTS OF LETTERS

## END FUNCTION () #40 - CONVERT EACH LETTER IN ELS SEARCH QUERY TO REGULAR EXPRESSIONS (REGEX)
