...
def fn_FileNamesCreate(XW, YH, NumberOfCodexChosen, NumberOfTextChosen, W4ELS, DELSO):
    ...
    ## TEST PRINT OUTPUT
    print("\n")  ## PRINT SPACE
    print("WITHIN FUNCTION:  BEGIN FUNCTION #98 - FILE NAMES CREATE FOR ELS TERMS - POSITIVE")
    ...
    for EachELSTuple in W4ELS:
        ...
        ## GET DELSO OBJECT
        DictOfMatches = DELSO[ELSNumber].DELSMLF_POS
        ...
        for key, value in DictOfMatches.items():
            ...
            if d > 0:
                ...
                FileNameForELSTerm = f"USER_FILE_WordsOfELSs_POSITIVE_ELS{ELSNumber}_ELSMatch{ELSMatchCounter}_d{d}_n{n}_k{k}_{CodexTitle}_{NumberOfTextChosen}{TextTitle}_{XWString}x{YHString}_{ELSTerm}.csv"
            ...
            ## ELSE IF SKIP DISTANCE (-d) IS NEGATIVE
                ...
                FileNameForELSTerm = f"USER_FILE_WordsOfELSs_NEGATIVE_ELS{ELSNumber}_-d{d}_n{n}_k{k}_ELSMatch{ELSMatchCounter}_{CodexTitle}_{NumberOfTextChosen}{TextTitle}_{XWString}x{YHString}_{ELSTerm}.csv"
    ...
    ## TEST PRINT OUTPUT
    print("\n")  ## PRINT SPACE
    print("WITHIN FUNCTION:  END FUNCTION #98 - FILE NAMES CREATE FOR ELS TERMS - POSITIVE")
